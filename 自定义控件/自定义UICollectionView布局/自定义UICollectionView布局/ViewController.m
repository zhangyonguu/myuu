...
{
    if ([self.collectionView.collectionViewLayout isKindOfClass:[MyLineLayout class]]) {
        [self.collectionView setCollectionViewLayout:[[UICollectionViewFlowLayout alloc] init] animated:YES];
    }
    else
    {
        [self.collectionView setCollectionViewLayout:[[MyLineLayout alloc] init] animated:YES];
    }
}
@end
