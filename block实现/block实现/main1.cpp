...
int main(int argc, const char * argv[]) {
  {
        int (*maxBlock)(int,int) = ((int (*)(int, int))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_ 0_DATA));

        printf("%d",((int (*)(__block_impl *, int, int))((__block_impl *)maxBlock)->FuncPtr)((__block_impl *)maxBlock, 2, 3));
    }
    return 0;
}
